...
def create_energy_monitor(
    ...
    try:
        from sunday.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from sunday.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from sunday.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from sunday.telemetry.energy_rapl import RaplEnergyMonitor
