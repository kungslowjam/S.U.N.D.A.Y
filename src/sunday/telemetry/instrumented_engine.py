...
from sunday.core.types import Message, TelemetryRecord
from sunday.engine._stubs import InferenceEngine, StreamChunk
...
class InstrumentedEngine(InferenceEngine):
    ...
    :class:`~sunday.telemetry.energy_monitor.EnergyMonitor`), it is
