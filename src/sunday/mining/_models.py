...
from sunday.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """SUNDAY support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "Validation tracked in open-sunday/SUNDAY#316."
        ),
    ),
    PearlModelSpec(
        ...
        notes=(
            "Planned target; Pearl artifact is not publicly available yet. "
            "Validation tracked in open-sunday/SUNDAY#317."
        ),
    ),
    PearlModelSpec(
        ...
        notes=(
            "Planned target; Pearl artifact is not publicly available yet. "
            "Validation tracked in open-sunday/SUNDAY#318."
        ),
    ),
    PearlModelSpec(
        ...
        notes=(
            ...
            "Validation tracked in open-sunday/SUNDAY#319."
        ),
    ),
)
