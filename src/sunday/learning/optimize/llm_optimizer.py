"""LLM-based optimizer for SUNDAY configuration tuning.

Uses a cloud LLM to propose optimal SUNDAY configs, inspired by DSPy's
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal SUNDAY configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an SUNDAY AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this SUNDAY evaluation result.")
        lines.append("")
