...
``~/.sunday/learning/skills/<skill-name>/optimized.toml``.
...
from sunday.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from sunday.core.config import DSPyOptimizerConfig
        from sunday.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from sunday.learning.agents.gepa_optimizer import GEPAAgentOptimizer
