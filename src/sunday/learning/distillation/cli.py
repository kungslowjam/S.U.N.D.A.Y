"""``sunday learning`` — distillation learning CLI subcommands.
...
def learning_init() -> None:
    ...
    from sunday.learning.distillation.checkpoint.store import CheckpointStore
...
def learning_run(autonomy: str) -> None:
    ...
    console.print("[dim]Use 'sunday learning history' to check results.[/dim]")
