...
from sunday.agents._stubs import AgentContext, BaseAgent
from sunday.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("sunday.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from sunday.core.types import Message as MsgType
                    from sunday.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("sunday.server")
                    _logger.warning(
