"""FastAPI application factory for the SUNDAY API server."""
...
from sunday.server.api_routes import include_all_routes
from sunday.server.comparison import comparison_router
from sunday.server.connectors_router import create_connectors_router
from sunday.server.dashboard import dashboard_router
from sunday.server.digest_routes import create_digest_router
from sunday.server.routes import router
from sunday.server.speech_routes import router as speech_router
from sunday.server.upload_router import router as upload_router
