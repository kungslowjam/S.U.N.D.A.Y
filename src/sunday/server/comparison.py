...
<title>SUNDAY — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>SUNDAY</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      SUNDAY runs models on your own hardware. Every inference call that would
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install SUNDAY and run AI locally
      with zero API costs.</div>
    <div class="code-block">
      <code>git clone https://github.com/open-sunday/SUNDAY.git
&& cd SUNDAY && uv sync</code>
...
document.getElementById('copy-btn').addEventListener('click', () => {
  const cmd = 'git clone https://github.com/open-sunday/'
    + 'SUNDAY.git && cd SUNDAY && uv sync';
