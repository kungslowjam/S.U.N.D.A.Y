...
if TYPE_CHECKING:
    from sunday.evals.core.types import EvalSuiteConfig
    from sunday.operators.types import OperatorManifest
    from sunday.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("sunday-agent" if has_agent else "sunday-direct")
