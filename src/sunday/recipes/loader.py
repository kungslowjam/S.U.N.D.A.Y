...
Recipes are the universal composition format for SUNDAY.  Each recipe
...
_USER_RECIPES_DIR = Path.home() / ".sunday" / "recipes"
_USER_OPERATORS_DIR = Path.home() / ".sunday" / "operators"
...
class Recipe:
    ...
    def to_eval_suite(
        ...
        """
        from sunday.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from sunday.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.sunday/recipes/`` directory
    4. User ``~/.sunday/operators/`` directory
