"""ToolTranslator — translate external tool names to SUNDAY equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  SUNDAY uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → SUNDAY name
# ---------------------------------------------------------------------------
