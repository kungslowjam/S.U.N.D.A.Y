...
from sunday.agents._stubs import AgentContext, AgentResult, BaseAgent
...
_OUTPUT_START = "---OPENSUNDAY_OUTPUT_START---"
_OUTPUT_END = "---OPENSUNDAY_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``sunday-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "sunday-sandbox:latest"
    DEFAULT_TIMEOUT = 300
