...
Provides transcript translation (SUNDAY events → PinchBench format),
...
from sunday.evals.core.event_recorder import EventType
from sunday.evals.core.scorer import LLMJudgeScorer
from sunday.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: SUNDAY name → PinchBench-expected name
# ---------------------------------------------------------------------------
