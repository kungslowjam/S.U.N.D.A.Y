...
from sunday.evals.backends._commit_util import sunday_commit
...
class JarvisDirectBackend(InferenceBackend):
    ...
    backend_id = "sunday-direct"
    framework_name = "sunday"
    ...
    def framework_commit_value(self) -> str:
        """SUNDAY repo HEAD commit (for telemetry tagging)."""
        from sunday.evals.backends._commit_util import sunday_commit

        return sunday_commit()
    ...
    def generate_full(
        ...
        *,
        ...
        return {
            ...
            "turn_count": 1,
            "framework": "sunday",
            "framework_commit": sunday_commit(),
            "error": None,
        }
