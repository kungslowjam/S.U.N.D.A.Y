"""Shared helper for resolving the sunday repo's HEAD commit."""
...
def sunday_commit() -> str:
    """Return the sunday repo's HEAD commit (cached, lru-1).
    ...
    """
    try:
        # Walk up to repo root: backends/ -> evals/ -> sunday/ -> src/ -> repo
