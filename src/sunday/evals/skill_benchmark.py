...
class SkillBenchmarkConfig:
    ...
    skills_dir: Path = field(
        default_factory=lambda: Path("~/.sunday/skills/").expanduser()
    )
    overlay_dir_dspy: Path = field(
        default_factory=lambda: Path("~/.sunday/learning/skills-dspy/").expanduser()
    )
    overlay_dir_gepa: Path = field(
        default_factory=lambda: Path("~/.sunday/learning/skills-gepa/").expanduser()
    )
...
class SkillBenchmarkRunner:
    ...
    def __init__(self, config: SkillBenchmarkConfig) -> None:
        ...
        # the default ~/.sunday/learning/skills/ tree.
