...
Routes incoming :class:`~sunday.channels._stubs.ChannelMessage` objects
...
from sunday.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in SUNDAY:\nsunday://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~sunday.agents._stubs.BaseAgent`
        subclass).
    max_workers:
