...
if TYPE_CHECKING:
    ...
    from sunday.channels._stubs import BaseChannel
    from sunday.learning._stubs import RouterPolicy
    ...
    from sunday.speech._stubs import SpeechBackend
...
class JarvisSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~sunday.channels._stubs.BaseChannel`
