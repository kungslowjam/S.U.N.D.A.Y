"""High-level Python SDK for SUNDAY."""
...
import sunday
from sunday.core.config import JarvisConfig, load_config
...
from sunday.system import JarvisSystem, SystemBuilder
...
class MemoryHandle:
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from sunday.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
...
class Jarvis:
    ...
    def version(self) -> str:
        """Return the SUNDAY version string."""
        return sunday.__version__
    ...
    def _run_agent(
        ...
        *,
        ...
        if tools:
            ...
            from sunday.cli.ask import _build_tools
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from sunday.tools.digest_collect import DigestCollectTool
            from sunday.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from sunday.cli.ask import _get_memory_backend
                from sunday.tools.storage.context import (
                    ContextConfig,
                    inject_context,
                )
