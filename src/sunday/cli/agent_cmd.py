"""``sunday agents`` — persistent agent lifecycle management."""
...
def list_agents() -> None:
    ...
    try:
        ...
        if not agents:
            console.print(
                "[dim]No agents found. Create one with: sunday agents create[/dim]"
            )
            return
...
def launch():
    ...
    from sunday.agents.manager import AgentManager as _AM
