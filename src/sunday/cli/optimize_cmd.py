"""``sunday optimize`` — LLM-driven configuration optimization CLI."""
...
def optimize_run(
    ...
    """Run an optimization loop over SUNDAY configuration."""
    ...
    if config_path is not None:
        try:
            from sunday.learning.optimize.config import load_optimize_config
        except ImportError:
    ...
    if data is not None:
        try:
            from sunday.learning.optimize.config import load_benchmark_specs
    ...
    try:
        ...
        from sunday.learning.optimize.config import load_objectives
        ...
        try:
            from sunday.evals.cli import _build_judge_backend
...
def skills(policy: str, min_traces: int, dry_run: bool) -> None:
    ...
    from sunday.learning.agents.skill_optimizer import SkillOptimizer
