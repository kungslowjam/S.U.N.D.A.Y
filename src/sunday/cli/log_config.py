"""Global logging configuration for the SUNDAY CLI."""
...
from sunday.security.credential_stripper import CredentialStripper
...
def setup_logging(
    ...
    Returns
    -------
    The configured ``sunday`` logger.
    """
    logger = logging.getLogger("sunday")
