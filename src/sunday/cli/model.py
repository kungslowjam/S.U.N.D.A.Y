"""``sunday model`` — model management subcommands."""
...
from sunday.core.registry import ModelRegistry
from sunday.engine import discover_engines, discover_models
from sunday.intelligence import merge_discovered_models, register_builtin_models
