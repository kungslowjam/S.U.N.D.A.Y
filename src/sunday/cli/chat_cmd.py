"""``sunday chat`` — interactive multi-turn chat REPL."""
...
from sunday.cli._tool_names import resolve_tool_names
...
def chat(
    ...
    from sunday.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import sunday.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]SUNDAY Chat[/green bold]\n"
    ...
    from sunday.cli._chat_notifications import NotificationDispatcher
