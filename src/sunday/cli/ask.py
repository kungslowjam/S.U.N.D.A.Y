"""``sunday ask`` — send a query to the assistant."""
...
from sunday.cli.hints import hint_no_engine
...
def ask(
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]sunday config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"
