...
The default path is `~/.sunday/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/sunday/security/index.md) — complete class and function signatures
