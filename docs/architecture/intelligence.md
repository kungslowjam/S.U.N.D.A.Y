...
```python
from sunday.intelligence import merge_discovered_models
...
The following names are still importable from `sunday.intelligence` via shim modules, but their canonical locations have moved:
