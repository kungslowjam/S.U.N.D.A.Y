---
title: Downloads
description: Download the SUNDAY desktop app, browser app, CLI, or Python SDK
---
...
!!! info "Backend required"
    ...
    ```bash
    git clone https://github.com/open-sunday/SUNDAY.git && cd SUNDAY
...
|----------|----------|-------|
| macOS (Apple Silicon) | [:material-download: **SUNDAY.dmg**](https://github.com/open-sunday/SUNDAY/releases/download/desktop-latest/SUNDAY_0.1.0_aarch64.dmg) | M1/M2/M3/M4 Macs |
| Windows (64-bit) | [:material-download: **SUNDAY-setup.exe**](https://github.com/open-sunday/SUNDAY/releases/download/desktop-latest/SUNDAY_0.1.0_x64-setup.exe) | Windows 10+ |
| Linux (DEB) | [:material-download: **SUNDAY.deb**](https://github.com/open-sunday/SUNDAY/releases/download/desktop-latest/SUNDAY_0.1.0_amd64.deb) | Ubuntu, Debian |
| Linux (RPM) | [:material-download: **SUNDAY.rpm**](https://github.com/open-sunday/SUNDAY/releases/download/desktop-latest/SUNDAY-0.1.0-1.x86_64.rpm) | Fedora, RHEL |
| Linux (AppImage) | [:material-download: **SUNDAY.AppImage**](https://github.com/open-sunday/SUNDAY/releases/download/desktop-latest/SUNDAY_0.1.0_amd64.AppImage) | Any distro |
...
by Apple. If you see **"SUNDAY is damaged and can't be opened"**, run this in
