---
title: Code Snippets
description: Copy-paste patterns for common SUNDAY tasks
---

# Code Snippets

Ready-to-use patterns for the most common SUNDAY tasks. Each snippet is self-contained and copy-pasteable.
...
Run with: `sunday compose run research_assistant "quantum computing advances"`

## API Server (1 command)

```bash
sunday serve --port 8000 --engine ollama --model qwen3:8b
```
...
docker run -p 8000:8000 sunday serve --host 0.0.0.0
```
