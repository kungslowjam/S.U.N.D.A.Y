...
//!
//! Rust translation of `src/sunday/core/config.py`.
...
/// Default config directory: `~/.sunday/`
pub fn default_config_dir() -> PathBuf {
    dirs_home().join(".sunday")
}

/// Default config file path: `~/.sunday/config.toml`
...
fn default_sandbox_image() -> String { "sunday-sandbox:latest".into() }
...
fn default_operators_dir() -> String { "~/.sunday/operators".into() }
