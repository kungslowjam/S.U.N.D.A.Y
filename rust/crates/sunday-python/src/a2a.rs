...
impl PyAgentCard {
    ...
    fn new(name: &str, description: &str, version: &str, url: &str) -> Self {
        Self {
            inner: sunday_a2a::AgentCard::new(name, description, version, url),
        }
    }
...
impl PyA2ATaskStore {
    ...
    fn new() -> Self {
        Self {
            inner: sunday_a2a::A2ATaskStore::new(),
        }
    }
    ...
    fn update_state(&mut self, id: &str, state: &str) -> bool {
        let s = match state {
            "pending" => sunday_a2a::TaskState::Pending,
            "active" => sunday_a2a::TaskState::Active,
            "completed" => sunday_a2a::TaskState::Completed,
            "cancelled" => sunday_a2a::TaskState::Cancelled,
            "failed" => sunday_a2a::TaskState::Failed,
            _ => return false,
        };
...
pub fn parse_a2a_request(json_str: &str) -> PyResult<String> {
    let req = sunday_a2a::parse_request(json_str)
