...
const OPTIN_KEY = 'sunday-desktop-optin';
const OPTIN_NAME_KEY = 'sunday-desktop-display-name';
const OPTIN_EMAIL_KEY = 'sunday-desktop-email';
const OPTIN_ANONID_KEY = 'sunday-desktop-anon-id';
