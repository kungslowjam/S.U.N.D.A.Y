# Pearl reference oracle (SUNDAY Phase 0 deliverable)
...
If it succeeds, this host can mine Pearl using the SUNDAY `cpu-pearl` provider
...
- When Pearl bumps `py-pearl-mining` API: re-run the smoke test against the
  new ref pinned in `SUNDAY/src/sunday/mining/_constants.py`.
