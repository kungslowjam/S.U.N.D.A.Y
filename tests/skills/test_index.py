...
from sunday.skills.index import SkillIndex
...
class TestSkillIndex:
    def test_load_index(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "sunday"
            source = "github.com/sunday/skills/research"
            sha256 = "abc123"
            tags = ["research"]
    ...
    def test_search_by_name(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "sunday"
            source = "github.com/sunday/skills/web_research"
            sha256 = "abc"
            tags = ["research"]
            required_capabilities = []
            ...
            author = "sunday"
            source = "github.com/sunday/skills/code_review"
            sha256 = "def"
            tags = ["coding"]
            required_capabilities = []
        """)
