...
def connector(tmp_path: Path):
    ...
    from sunday.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("sunday.connectors.gdrive._gdrive_api_list_files")
@patch("sunday.connectors.gdrive._gdrive_api_export")
