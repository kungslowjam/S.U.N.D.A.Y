...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from sunday.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from sunday.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from sunday.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from sunday.connectors.google_tasks import GoogleTasksConnector
