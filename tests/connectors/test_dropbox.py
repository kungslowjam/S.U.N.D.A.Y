...
def connector(tmp_path: Path):
    ...
    from sunday.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("sunday.connectors.dropbox._dropbox_api_list_folder")
@patch("sunday.connectors.dropbox._dropbox_api_download")
