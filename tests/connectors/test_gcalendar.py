...
def connector(tmp_path: Path):
    ...
    from sunday.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "sunday.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("sunday.connectors.gcalendar._gcal_api_calendars_list")
@patch("sunday.connectors.gcalendar._gcal_api_events_list")
