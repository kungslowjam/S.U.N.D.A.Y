"""Smoke tests for ``sunday optimize`` and ``sunday feedback`` CLI commands,
...
class TestOptimizeConfig:
    ...
    def test_optimize_config_in_sunday_config(self):
        from sunday.core.config import JarvisConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from sunday.core.config import OptimizeConfig
