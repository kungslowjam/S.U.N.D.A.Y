...
class TestGRPOConfig:
    def test_default_config(self) -> None:
        from sunday.core.config import GRPOConfig
...
class TestDefaultRewardFn:
    def test_score_returns_float(self) -> None:
        from sunday.learning.intelligence.grpo_trainer import DefaultRewardFn
...
class TestGRPOTrainer:
    def test_init(self) -> None:
        from sunday.core.config import GRPOConfig
        from sunday.learning.intelligence.grpo_trainer import GRPOTrainer
