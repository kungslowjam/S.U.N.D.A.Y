"""Tests for sunday.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from sunday.evals.core.types import RunConfig, RunSummary
from sunday.learning.optimize.trial_runner import TrialRunner
from sunday.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_agent_maps_to_agent_backend(self) -> None:
        ...
        assert cfg.backend == "sunday-agent"
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "sunday-direct"
...
class TestRunTrial:
    ...
    @patch("sunday.evals.cli._build_scorer")
    @patch("sunday.evals.cli._build_judge_backend")
    @patch("sunday.evals.cli._build_dataset")
    @patch("sunday.evals.cli._build_backend")
    @patch("sunday.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from sunday.evals.core.types import EvalResult
