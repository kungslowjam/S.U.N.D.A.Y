...
from sunday.learning.routing.learned_router import LearnedRouterPolicy
...
class TestLearnedRouterPolicy:
    def test_registered_as_learned(self) -> None:
        from sunday.core.registry import RouterPolicyRegistry
        from sunday.learning.routing.learned_router import ensure_registered
