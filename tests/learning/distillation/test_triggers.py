"""Tests for sunday.learning.distillation.triggers module."""
...
class TestScheduledTrigger:
    def test_constructs(self) -> None:
        from sunday.learning.distillation.triggers import ScheduledTrigger
...
class TestClusterTrigger:
    def test_constructs(self) -> None:
        from sunday.learning.distillation.triggers import ClusterTrigger
