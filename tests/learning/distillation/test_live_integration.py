...
- TraceStore at ~/.sunday/traces.db with some traces
"""
...
def real_trace_store():
    ...
    db_path = Path.home() / ".sunday" / "traces.db"
    if not db_path.exists():
        pytest.skip("No traces.db found at ~/.sunday/")
...
class TestTeacherAgentLive:
    ...
    def test_teacher_agent_single_turn(self, cloud_engine) -> None:
        from sunday.learning.distillation.diagnose.teacher_agent import (
            TeacherAgent,
        )
...
class TestDiagnosisRunnerLive:
    ...
    def test_diagnosis_produces_output(
        ...
        from sunday.learning.distillation.diagnose.runner import (
            DiagnosisRunner,
        )
...
class TestColdStartLive:
    ...
    def test_orchestrator_cold_start_with_no_feedback(
        ...
        from sunday.learning.distillation.gate.cold_start import (
