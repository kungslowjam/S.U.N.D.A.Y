"""Tests for sunday.learning.distillation.execute.base module."""
...
class TestApplyContext:
    ...
    def test_constructs(self, tmp_path: Path) -> None:
        ...
        ctx = ApplyContext(sunday_home=tmp_path, session_id="s1")
        assert ctx.sunday_home == tmp_path
...
class TestValidationResult:
    ...
    def test_ok_result(self) -> None:
        from sunday.learning.distillation.execute.base import ValidationResult
...
class TestEditApplierRegistry:
    ...
    def test_register_and_get(self) -> None:
        from sunday.learning.distillation.execute.base import (
            ApplyContext,
            ApplyResult,
            EditApplier,
            EditApplierRegistry,
        ...
        from sunday.learning.distillation.models import Edit, EditOp
