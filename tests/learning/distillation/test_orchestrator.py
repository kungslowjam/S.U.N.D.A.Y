...
from sunday.learning.distillation.triggers import OnDemandTrigger
...
def _make_diagnosis_result():
    from sunday.learning.distillation.diagnose.runner import DiagnosisResult
...
class TestDistillationOrchestrator:
    def test_full_session_completes(self, tmp_path: Path) -> None:
        from sunday.learning.distillation.orchestrator import (
        ...
        with patch(
            "sunday.learning.distillation.orchestrator.DiagnosisRunner"
        ) as MockDiag:
