...
class TestClassifyMentionDispatch:
    ...
    def test_valid_labels_pass_through(self, llm_label, expected):
        ...
        assert _classify_mention("some tweet", sunday=j) == expected
    ...
    def test_defaults_to_question_if_model_returns_other(self):
        ...
        assert _classify_mention("hahaha", sunday=j) == "QUESTION"
...
class TestPromptBuilders:
    ...
    def test_bug_prompt_contains_github_url(self):
        ...
        assert "api.github.com/repos/open-sunday/SUNDAY/issues" in prompt
...
class TestMentionPolling:
    ...
    def test_poll_dispatches_to_handler(self):
            ...
            "data": [
                {
                    "id": "111",
                    "author_id": "alice",
                    "text": "@SUNDAYAI how do I install?",
                    "conversation_id": "111",
                },
            ],
        }
        ...
        assert msg.content == "@SUNDAYAI how do I install?"
...
class TestEnvVarExpansion:
    ...
    def test_github_token_expanded(self):
        ...
        with (
            ...
            patch(
                "sunday._rust_bridge.get_rust_module",
                return_value=mock_rust,
            ),
            patch("sunday.tools.http_request.check_ssrf", return_value=None),
            patch(
                "sunday.tools.http_request.httpx.request",
...
class TestFullE2EFlow:
    ...
    def _make_mock_sunday(self, responses=None):
    ...
    def test_question_flow(self):
        ...
        """
        j = self._make_mock_sunday(["check the docs at open-sunday.github.io"])
        tweet = DEMO_TWEETS[0]
    ...
    def test_bug_report_flow(self):
        ...
        j = self._make_mock_sunday(["opened an issue for this"])
        tweet = DEMO_TWEETS[1]
    ...
    def test_praise_flow(self):
        ...
        j = self._make_mock_sunday(["thanks, glad you like it!"])
        tweet = DEMO_TWEETS[3]
        mention_type = "PRAISE"
    ...
    def test_all_demo_tweets_processed(self):
        ...
        TestClassifyMentionDispatch against a mocked sunday. This test
...
class TestGitHubIssueCreation:
    ...
    def test_create_bug_issue(self):
        ...
        mock_resp.text = json.dumps({
            "number": 42,
            "html_url": "https://github.com/open-sunday/SUNDAY/issues/42",
        })
        mock_resp.headers = {"content-type": "application/json"}

        with (
            patch.dict(os.environ, {"GITHUB_TOKEN": "ghp_testtoken123"}),
            patch("sunday._rust_bridge.get_rust_module", return_value=mock_rust),
            patch("sunday.tools.http_request.check_ssrf", return_value=None),
            patch(
                "sunday.tools.http_request.httpx.request",
                return_value=mock_resp,
