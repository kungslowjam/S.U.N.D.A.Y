...
from sunday.core.registry import AgentRegistry, ToolRegistry
...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from sunday.agents.native_openhands import NativeOpenHandsAgent
        from sunday.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from sunday.mcp.transport import InProcessTransport
        from sunday.tools.calculator import CalculatorTool
        from sunday.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from sunday.mcp.client import MCPClient
        from sunday.mcp.protocol import MCPError
        from sunday.mcp.server import MCPServer
        from sunday.mcp.transport import InProcessTransport
        from sunday.tools.calculator import CalculatorTool
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from sunday.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
