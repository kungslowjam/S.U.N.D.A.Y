...
from sunday.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
...
class TestHeuristicRewardWithTelemetry:
    ...
    def test_reward_from_telemetry_record(self):
        from sunday.learning._stubs import RoutingContext
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from sunday.learning._stubs import RoutingContext
        from sunday.learning.routing.heuristic_policy import ensure_registered
        from sunday.learning.routing.router import HeuristicRouter
...
class TestSDKImport:
    """Verify Jarvis class is importable from sunday."""

    def test_sunday_imports(self):
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        from sunday.sdk import Jarvis

        engine = _make_engine("SDK response")
        with patch("sunday.sdk.get_engine", return_value=("mock", engine)):
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from sunday.core.config import JarvisConfig
        from sunday.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from sunday.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from sunday.bench import ensure_registered
        from sunday.bench._stubs import BenchmarkSuite
        from sunday.core.registry import BenchmarkRegistry
