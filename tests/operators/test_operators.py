...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "sunday.agents._stubs.load_config",
...
class TestSystemAskPassthrough:
    def test_system_prompt_forwarded(self):
        ...
        from sunday.system import QueryOrchestrator
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from sunday.core.config import OperatorsConfig
    ...
    def test_config_in_sunday_config(self):
        from sunday.core.config import JarvisConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "sunday" / "operators" / "data"
