...
class TestGetRustModule:
    ...
    def test_returns_rust_module(self):
        """get_rust_module() returns the sunday_rust module."""
        ...
        assert result.__name__ == "sunday_rust"
...
class TestScanResultFromJson:
    ...
    def test_empty_findings(self):
        from sunday._rust_bridge import scan_result_from_json
...
class TestInjectionResultFromJson:
    ...
    def test_clean(self):
        from sunday._rust_bridge import injection_result_from_json
...
class TestRetrievalResultsFromJson:
    ...
    def test_empty(self):
        from sunday._rust_bridge import retrieval_results_from_json
...
class TestRustBackedModules:
    ...
    def test_injection_scanner_uses_rust(self):
        ...
        from sunday.security.injection_scanner import InjectionScanner
    ...
    def test_rate_limiter_uses_rust(self):
        ...
        from sunday.security.rate_limiter import RateLimiter
