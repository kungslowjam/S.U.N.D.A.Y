"""Tests for the ``sunday registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the sunday registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "sunday.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"sunday.core.registry": None}):
