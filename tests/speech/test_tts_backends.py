...
from sunday.core.registry import TTSRegistry
from sunday.speech.tts import TTSResult
...
def test_cartesia_registered():
    from sunday.speech.cartesia_tts import CartesiaTTSBackend
...
def test_cartesia_synthesize():
    ...
    with patch(
        "sunday.speech.cartesia_tts._cartesia_synthesize",
...
def test_kokoro_registered():
    from sunday.speech.kokoro_tts import KokoroTTSBackend
...
def test_openai_tts_registered():
    from sunday.speech.openai_tts import OpenAITTSBackend
...
def test_openai_tts_synthesize():
    ...
    with patch(
        "sunday.speech.openai_tts._openai_tts_request",
