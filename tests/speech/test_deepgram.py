...
from sunday.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("sunday.speech.deepgram.DeepgramClient", return_value=mock_client):
        from sunday.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("sunday.speech.deepgram.DeepgramClient"):
        from sunday.speech.deepgram import DeepgramSpeechBackend
