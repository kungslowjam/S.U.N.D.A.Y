...
class TestDetectHardware:
    ...
    @patch("sunday.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "sunday.core.config._run_cmd",
    ...
    @patch("sunday.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "sunday.core.config._run_cmd",
        side_effect=[
    ...
    @patch("sunday.core.config.platform.system", return_value="Darwin")
    @patch(
        "sunday.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("sunday.core.config.shutil.which", return_value=None)
    @patch("sunday.core.config.platform.system", return_value="Linux")
