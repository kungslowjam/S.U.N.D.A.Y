...
_PATCH_HTTP = "sunday.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "sunday.mcp.transport.StdioTransport"
_PATCH_CLIENT = "sunday.mcp.client.MCPClient"
_PATCH_PROVIDER = "sunday.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "sunday.system.builder.logger"
