"""Tests for the Rich display helpers in sunday.evals.core.display."""
...
from sunday.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "SUNDAY" in output or "___" in output
