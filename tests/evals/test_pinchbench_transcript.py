...
from sunday.evals.core.event_recorder import AgentEvent, EventType
from sunday.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from sunday.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """SUNDAY tool names are mapped to PinchBench-expected names."""
    from sunday.evals.scorers.pinchbench import events_to_transcript
