#!/usr/bin/env python3
"""Index SUNDAY docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual SUNDAY docs the boilerplate that
    # crowds retrieval ("SUNDAY runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does sunday support?",
